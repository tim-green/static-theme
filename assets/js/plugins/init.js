(function ($) {
	...
	var staticApp = {
	    ...
	    scroll_top: function () {
	    	...
	    	//Scroll Top Event
	    	var $scroll_top_enable = static.scroll_top;
	    	...
	    	var $sticky_contact_btn = static.sticky_contact;
	    	var $sticky_contact_url = static.sticky_contact_url;
		...
		/* ---------------------------------------------
		 ...
		 --------------------------------------------- */
		initializ: function() {
			staticApp.onePageMenu();
			staticApp.sh_lm_menu();
			staticApp.sh_lm_select();
			staticApp.coming_soon_timer();
			staticApp.datePicker();
			staticApp.scroll_top();
		}
	};
	/* ---------------------------------------------
	...
	$(window).on('load', function() {
		staticApp.header_overlay();
		staticApp.hoverAnimation();
		staticApp.preloader();
		staticApp.service_item_mobile();
	});
})(jQuery);
