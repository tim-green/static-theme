 ...
 * @access public
 */
class static_Customizer_Range_Value_Control extends WP_Customize_Control {
	...
	/**
	 * static_Customizer_Range_Value_Control constructor.
	 *
 ...
 * @since 1.0
 */
function static_sanitize_range_value( $input ) {
	if ( staticis_json( $input ) ) {
