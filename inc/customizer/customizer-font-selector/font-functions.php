 ...
 * @since 1.0
 */
function static_get_standard_fonts() {
	return apply_filters(
		'staticstandard_fonts_array', array(
 ...
 * @since 1.0
 */
function static_enqueue_google_font( $font ) {
	...
	$subsets     = '';
	$get_subsets = static_get_options( array('font_subsets', array( 'latin' ) ) );
	...
	// Weights
	$weights = apply_filters( 'static_font_weights', array( '300', '400', '500', '700', '800' ) );
	...
	// Enqueue style
	wp_enqueue_style( 'static-google-font-' . $handle, $url, array(), false );
}

function static_enqueue_google_font_url( $font ) {
	// Get list of all Google Fonts
	$google_fonts = static_get_google_fonts_array();
